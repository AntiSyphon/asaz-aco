...
# Copy Wallpaper
$wc.DownloadFile('https://github.com/AntiSyphon/asaz-aco/raw/main/1-AD/resources/AS.jpg', 'C:\ProgramData\AS.jpg')

# Copy BGInfo config
$wc.DownloadFile('https://github.com/AntiSyphon/asaz-aco/raw/main/1-AD/resources/asazlab.bgi', 'C:\ProgramData\asazlab.bgi')
